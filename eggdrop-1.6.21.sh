...
echo "Selamat Datang di UkhuwahNet Teams automated Enggdrop builder!"
echo ""
...
echo ""
echo "Downloading eggdrop version 1.6.21..."
mkdir eggdrop
cd eggdrop
wget http://164.132.231.84/hasby/downloads/eggdrop/eggdrop-1.6.21.tgz
tar -xzvf eggdrop-1.6.21.tgz
ls -al
rm -rf eggdrop-1.6.21.tgz
echo ""
